...
export const OCADO_ITEMS = {
  ...
  'butternut squash':   { search: 'butternut squash', must: ['butternut'], not: ['soup', 'spiralized', 'noodle', 'risotto', 'ravioli'] },
  'paneer':             { search: 'paneer cheese block', must: ['paneer'], not: ['curry', 'ready', 'meal', 'masala', 'chilli', 'kolkata', 'saag', 'wrap', 'pakora'] },
  'butter beans':       { search: 'butter beans tin', must: ['butter bean'], not: ['organic'], netFactor: 0.6 },
  'bacon lardons':      { search: 'smoked bacon lardons', must: ['lardon|pancetta'], not: ['ready to eat'] },
  'pak choi':           { search: 'pak choi', must: ['pak choi|bok choy'], not: ['ready', 'stir fry mix'] },
  'mangetout':          { search: 'mangetout', must: ['mangetout|mange tout'], not: ['mix'] },
  'cashews':            { search: 'cashew nuts plain', must: ['cashew'], not: ['salted|roasted honey|chilli|caramel|chocolate|butter'] },
  'pearl barley':       { search: 'pearl barley', must: ['pearl barley'], not: ['soup mix'], netFactor: 2.5 },
  'smoked mackerel':    { search: 'smoked mackerel fillets', must: ['smoked', 'mackerel'], not: ['pate|paté|in olive oil|in brine|in spring water|in tomato|in sunflower'] },
  'parsnips':           { search: 'parsnips', must: ['parsnip'], not: ['soup', 'crisps', 'honey roast', 'prepared'] },
  'white cabbage':      { search: 'white cabbage', must: ['cabbage'], not: ['red', 'savoy', 'shredded slaw', 'coleslaw', 'pickled'] },
  'apples':             { search: 'apples pack', must: ['apple'], not: ['juice', 'sauce', 'cider', 'pie', 'crumble', 'toffee'] },
  ...
  // ---- snacks & essentials (extras, not recipe ingredients) ----
  'milk chocolate':     { search: 'milk chocolate bar', must: ['milk', 'chocolate'], not: ['biscuit', 'digestive', 'drink', 'button', 'advent'] },
  'dark chocolate':     { search: 'dark chocolate 70%', must: ['dark', 'chocolate'], not: ['biscuit', 'drink', 'orange'] },
  'crisps':             { search: 'ready salted crisps multipack', must: ['crisps'], not: ['prawn', 'veg', 'lentil'] },
  'tortilla chips':     { search: 'tortilla chips lightly salted', must: ['tortilla'], not: ['wrap', 'fajita'] },
  'salsa':              { search: 'salsa dip', must: ['salsa'], not: ['verde'] },
  'houmous':            { search: 'houmous', must: ['houmous|hummus'], not: ['topped', 'sweet'] },
  'mixed nuts':         { search: 'mixed nuts unsalted', must: ['nut'], not: ['chocolate', 'yogurt', 'butter', 'doughnut'] },
  'popcorn':            { search: 'sweet salted popcorn', must: ['popcorn'], not: ['kernels', 'toffee'] },
  ...
  'cereal bars':        { search: 'oat cereal bars', must: ['bar'], not: ['soap', 'chocolate bar'] },
  'rice cakes': { search: 'plain rice cakes', must: ['rice cake'], not: ['chocolate', 'caramel', 'yogurt', 'strawberry', 'salt'] },
  'apples':             { search: 'M&S apples', must: ['apple'], not: ['juice', 'sauce', 'pie', 'cider', 'strudel'] },
  'oranges':            { search: 'M&S oranges', must: ['orange'], not: ['juice', 'chocolate', 'squash', 'jelly'] },
  'grapes':             { search: 'M&S seedless grapes', must: ['grape'], not: ['juice', 'grapefruit'] },
  'tea bags':           { search: 'everyday tea bags 80', must: ['tea'], not: ['green', 'herbal', 'fruit', 'towel'] },
  'instant coffee':     { search: 'instant coffee granules', must: ['instant', 'coffee'], not: ['decaf', 'sachets'] },
  'ground coffee':      { search: 'ground coffee', must: ['coffee'], not: ['instant', 'pods', 'machine', 'mug', 'cake'] },
  'sugar':              { search: 'granulated sugar', must: ['sugar'], not: ['icing', 'caster', 'brown', 'syrup', 'cube'] },
  'orange juice':       { search: 'orange juice 1l', must: ['orange', 'juice'], not: ['sparkling', 'cordial', 'squash'] },
  'sparkling water':    { search: 'sparkling water', must: ['sparkling', 'water'], not: ['lemon', 'lime', 'berry', 'elderflower', 'peach'] },
  'cereal':             { search: 'cornflakes', must: ['cornflakes|corn flakes'], not: ['chocolate', 'cake'] },
  'toilet roll':        { search: 'toilet roll 9 pack', must: ['toilet'], not: ['wipe', 'bleach', 'block', 'holder', 'brush'] },
  'kitchen roll':       { search: 'kitchen roll', must: ['kitchen'], not: ['cleaner', 'bin', 'towel dispenser', 'foil'] },
  ...
  'dishwasher tablets': { search: 'dishwasher tablets all in one', must: ['dishwasher'], not: ['salt', 'rinse', 'cleaner', 'freshener'] },
  'laundry pods':       { search: 'laundry capsules', must: ['capsule|pod', 'wash|laundry'], not: ['dishwasher', 'coffee'] },
  'surface cleaner':    { search: 'antibacterial surface cleaner spray', must: ['clean'], not: ['floor', 'oven', 'wipes', 'bathroom'] },
  'bin bags':           { search: 'bin liners', must: ['bin'], not: ['pedal bin', 'caddy', 'food waste'] },
  'tin foil':           { search: 'aluminium foil', must: ['foil'], not: ['baking paper', 'container', 'platter'] },
  'toothpaste':         { search: 'toothpaste whitening', must: ['toothpaste'], not: ['kids', 'brush', 'mouthwash'] },
  'shampoo':            { search: 'shampoo', must: ['shampoo'], not: ['conditioner', 'pet', 'carpet', 'dry shampoo'] },
  'shower gel':         { search: 'shower gel', must: ['shower'], not: ['head', 'curtain', 'cap'] },
  'hand soap': { search: 'M&S hand wash', must: ['hand'], not: ['sanitiser', 'cream', 'dishwash', 'body'] },
};
