...
export const ALDI_ITEMS = {
  ...
  "butternut squash": { search: "butternut squash whole fresh", must: ["butternut"], not: ["soup","prepared","diced","spiralized","noodle","girasoli","ravioli","pasta","risotto","tortelloni","bake","feta","chipotle","spicy","stuffed"] },
  "paneer": { search: "paneer", must: ["paneer"], not: ["curry","ready","meal"] },
  "butter beans": { search: "butter beans", must: ["butter bean"], netFactor: 0.6 },
  "bacon lardons": { search: "bacon lardons", must: ["lardon|pancetta"], not: ["ready to eat"] },
  ...
  "cashews": { search: "cashew nuts", must: ["cashew"], not: ["salted","honey","chilli","caramel","chocolate","butter"] },
  "pearl barley": { search: "pearl barley", must: ["pearl barley"], not: ["soup"], netFactor: 2.5 },
  "smoked mackerel": { search: "smoked mackerel fillets", must: ["mackerel"], not: ["pate","tinned","in tomato","in sunflower"] },
  "parsnips": { search: "parsnips", must: ["parsnip"], not: ["soup","crisps","honey"] },
  "white cabbage": { search: "white cabbage whole", must: ["cabbage"], not: ["red","savoy","slaw","coleslaw","pickled","peas","tenderstem","broccoli","mix","shredded","sweetheart"] },
  "apples": { search: "apples", must: ["apple"], not: ["juice","sauce","cider","pie","crumble","toffee"] },
